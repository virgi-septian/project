...
@section('title')
<title>Order {{ $order->invoice }} - Ebagja</title>
@endsection
                            ...
                            <div class="card-body">
                                <table>
                                    <tr>
                                        ...
                                        <td width="5%">:</td>
                                        <th><span href="{{ route('customer.order_pdf', $order->invoice) }}" target="_blank"><strong>{{ $order->invoice }}</strong></span></th>
                                    </tr>
                                    <tr>
                                        <td>Nama Lengkap</td>
                                        <td width="5%">:</td>
                            ...
                            <div class="card-body">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                            <img src="{{ asset('payment/' . $order->payment->proof) }}" width="50px" height="50px" alt="">
