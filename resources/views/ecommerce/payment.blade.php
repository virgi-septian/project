...
@section('title')
    <title>Konfirmasi Pembayaran - Ebagja</title>
@endsection
                                    ...
                                    <form action="{{ route('customer.savePayment') }}" enctype="multipart/form-data" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="transfer_to" class="form-control" required>
                                                ...
                                                <option value="BCA - 1234567">BCA: 1234567 a.n Ebagja</option>
                                                <option value="Mandiri - 2345678">Mandiri: 2345678 a.n Ebagja</option>
                                                <option value="BRI - 9876543">BRI: 9876543 a.n Ebagja</option>
                                                <option value="BNI - 6789456">BNI: 6789456 a.n Ebagja</option>
                                            </select>
