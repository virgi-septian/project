                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    <select hidden name="status" class="form-control" required>
                                        <option hidden value="1" {{ $product->status == '1' ? 'selected':'' }}>Publish</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <img src="{{ asset('product/'. $product->image) }}" width="100px" height="100px" alt="{{ $product->name }}">
                                    <hr>
